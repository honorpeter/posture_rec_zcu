...
reg	[9:0]	conv_cnt,conv_mub;

//input[15:0]     LAYER1_RETURN_NUM,    //8//the returned number of image in layer 1
//input[15:0]     LAYER2_RETURN_NUM,    //16//the returned number of image in layer 2
//input[15:0]     LAYER3_RETURN_NUM,    //32//......................................3
//input[15:0]     LAYER4_RETURN_NUM,    //64//.....................................4
//input[15:0]     LAYER5_RETURN_NUM,    //128//.....................................5
//input[15:0]     LAYER6_RETURN_NUM,    //256//.....................................6
//input[15:0]     LAYER7_RETURN_NUM,    //40//....................................7
...
/*reg	[3:0]	conv_layer_change_state;
parameter	conv_layer_change_idle	=	'd10,
			conv_layer_change_start	=	'd9,
			conv_layer_change_layer1	=	'd1,
			conv_layer_change_layer2	=	'd2,
			conv_layer_change_layer3	=	'd3,
			conv_layer_change_layer4	=	'd4,
			conv_layer_change_layer5	=	'd5,
			conv_layer_change_layer6	=	'd6,
			conv_layer_change_layer7	=	'd7,
			conv_layer_change_end	=	'd8;
...
begin
		if(!rst_n)begin
			...
			conv_layer_change_start:
				conv_layer_change_state	<=	conv_layer_change_layer1;
			conv_layer_change_layer1:begin
			    if(algorithm_finish) conv_layer_change_state	<=	conv_layer_change_layer1;
			    else if(image_one_return_finish)
					conv_cnt <= conv_cnt + 1'b1;
				else if(conv_cnt == `LAYER1_RETURN_NUM)begin
					conv_layer_change_state	<=	conv_layer_change_layer2;
					conv_cnt <= 10'h0;
			...
			conv_layer_change_layer2:begin
			    if(algorithm_finish) conv_layer_change_state	<=	conv_layer_change_layer2;
                else if(image_one_return_finish)
					conv_cnt <= conv_cnt + 1'b1;
				else if(conv_cnt == `LAYER2_RETURN_NUM)begin
					conv_cnt <= 10'h0;
			...
			conv_layer_change_layer3:begin
				if(algorithm_finish) conv_layer_change_state	<=	conv_layer_change_layer3;
                else if(image_one_return_finish)
					conv_cnt <= conv_cnt + 1'b1;
				else if(conv_cnt == `LAYER3_RETURN_NUM)begin
					conv_cnt <= 10'h0;
			...
			conv_layer_change_layer4:begin
				if(algorithm_finish) conv_layer_change_state	<=	conv_layer_change_layer4;
                else if(image_one_return_finish)
					conv_cnt <= conv_cnt + 1'b1;				
				else if(conv_cnt == `LAYER4_RETURN_NUM)begin
					conv_cnt <= 10'h0;
			...
			conv_layer_change_layer5:begin
				if(algorithm_finish) conv_layer_change_state	<=	conv_layer_change_layer5;
                else if(image_one_return_finish)
					conv_cnt <= conv_cnt + 1'b1;				
				else if(conv_cnt == `LAYER5_RETURN_NUM)begin
					conv_cnt <= 10'h0;
			...
			conv_layer_change_layer6:begin
				if(algorithm_finish) conv_layer_change_state	<=	conv_layer_change_layer6;
                else if(image_one_return_finish)
					conv_cnt <= conv_cnt + 1'b1;			
				else if(conv_cnt == `LAYER6_RETURN_NUM)begin
					conv_cnt <= 10'h0;
			...
			conv_layer_change_layer7:begin
				if(algorithm_finish) conv_layer_change_state	<=	conv_layer_change_layer7;
                else if(image_one_return_finish)
					conv_cnt <= conv_cnt + 1'b1;						
				else if(conv_cnt == `LAYER7_RETURN_NUM)begin
					conv_cnt <= 10'h0;
...
assign	algorithm_finish	=	(conv_layer_change_state == stop_layer && 
								conv_cnt == conv_mub) ? 1'b1 : 1'b0;*/
...
//	.probe4(algorithm_finish), // input wire [9:0]  probe1 
//    .probe5(stop_layer), // input wire [0:0]  probe2 
//    .probe6(conv_mub) // input wire [0:0]  probe3
//);
