...
#
# Generated by export_simulation on Wed Apr 25 15:49:14 +0800 2018
#
################################################################################
...
'-reset_run' switch to the './image_ram_rd_addr_add.sh' script.

./image_ram_rd_addr_add.sh -reset_run
...
./image_ram_rd_addr_add.sh -noclean_files

For more information on the script, please type './image_ram_rd_addr_add.sh -help'.
