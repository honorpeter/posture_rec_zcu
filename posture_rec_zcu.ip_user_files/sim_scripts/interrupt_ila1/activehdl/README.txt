...
#
# Generated by export_simulation on Thu May 17 10:28:00 +0800 2018
#
################################################################################
...
'-reset_run' switch to the './interrupt_ila1.sh' script.

./interrupt_ila1.sh -reset_run
...
./interrupt_ila1.sh -noclean_files

For more information on the script, please type './interrupt_ila1.sh -help'.
