...
#
# Generated by Vivado on Thu May 17 10:10:21 +0800 2018
# SW Build 2188600 on Wed Apr  4 18:40:38 MDT 2018
#
# Copyright 1986-2018 Xilinx, Inc. All Rights Reserved. 
#
# usage: float_multiply.sh [-help]
# usage: float_multiply.sh [-lib_map_path]
# usage: float_multiply.sh [-noclean_files]
# usage: float_multiply.sh [-reset_run]
#
...
# executing this script. Please type 'float_multiply.sh -help' for more information.
#
...
# Script info
echo -e "float_multiply.sh - Script generated by export_simulation (Vivado v2018.1 (64-bit)-id)\n"
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../ip/float_multiply/sim/float_multiply.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.float_multiply xil_defaultlib.glbl -o float_multiply_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./float_multiply_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./float_multiply.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key float_multiply_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc float_multiply_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./float_multiply.sh -help\" for more information)\n"
    exit 1
  fi
...
usage()
{
  msg="Usage: float_multiply.sh [-help]\n\
Usage: float_multiply.sh [-lib_map_path]\n\
Usage: float_multiply.sh [-reset_run]\n\
Usage: float_multiply.sh [-noclean_files]\n\n\
